#!/usr/bin/env python3
"""Initialize credentials tables only."""
...
print("=" * 80)
print("INITIALIZING CREDENTIALS TABLES")
print("=" * 80)
...
try:
    ...
    print("✓ Credentials tables initialized successfully")
except Exception as e:
    print(f"✗ Error initializing credentials tables: {e}")
    import traceback
    traceback.print_exc()
    sys.exit(1)
