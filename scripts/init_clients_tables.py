#!/usr/bin/env python3
"""Initialize clients tables only."""
...
print("=" * 80)
print("INITIALIZING CLIENTS TABLES")
print("=" * 80)

from campus.auth.resources.client import ClientsResource

print("\nInitializing clients tables...")
try:
    ClientsResource.init_storage()
    print("✓ Clients tables initialized successfully")
except Exception as e:
    print(f"✗ Error initializing clients tables: {e}")
    import traceback
    traceback.print_exc()
    sys.exit(1)
