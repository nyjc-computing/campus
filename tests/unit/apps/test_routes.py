"""Unit tests for campus.apps routes.

Tests the route logic in campus.apps.api.routes without external dependencies.
Mocks database calls and external services.
"""
